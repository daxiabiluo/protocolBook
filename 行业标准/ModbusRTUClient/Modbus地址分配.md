...
| 寄存器地址      | 功能码              | 寄存器种类   | 读写状态 |
| --------------- | ------------------- | ------------ | -------- |
| 0x00001-0x65535 | 0x01、 0x05、 0x0F  | 线圈状态     | 可读可写 |
| 1x00001-1x65535 | 0x02                | 离散输入状态 | 可读     |
| 3x00001-3x65535 | 0x04                | 输入寄存器   | 可读     |
| 4x00001-4x65535 | 0x03、  0x06、0x 0F | 保存寄存器   | 可读可写 |
